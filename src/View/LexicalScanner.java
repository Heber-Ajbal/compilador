 ...
 * from the specification file <tt>C:/Users/Digitacion Nery/Desktop/compilador/src/analyzer/Lex.flex</tt>
 */
...
private String getColorForType(String tipo) {
    return switch (tipo.toLowerCase()) {
        case "palabra reservada" -> "#2563EB";      // Azul brillante
        case "tipo de dato" -> "#8B5CF6";           // Violeta
        case "identificador" -> "#000000";          // Negro
        case "número" -> "#10B981";                 // Verde
        case "cadena" -> "#F59E0B";                 // Naranja
        case "operador" -> "#fb5404";               // Rojo fuerte
        case "comentario" -> "#1bb400";             // Verde claro
        case "signo de puntuación" -> "#E11D48";    // Rojo rosado fuerte (nuevo)
        case "directiva de procesamiento" -> "#DB3069"; // Magenta
        case "error" -> "#FF1493";                  // Rosa fuerte
        default -> "#000000";                       // Por defecto
    };
}
